...
2026-09-10 接续：用户新增马厩外侧接近时侧面显露的提议，下一步以 Stable v4 做带马四向及左右侧远／近状态示意，并补充无马状态；之后比较一间棚屋的内外转向。详见[室内与马厩方案](../../interior-and-stable-plan.md)。尚未生成这些新示意，本页图片和检查记录保持原版本。
